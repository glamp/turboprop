...
class CodeSnippet:
    ...
    def __str__(self) -> str:
        ...
        return f"{line_info}: {self.text[:100]}{'...' if len(self.text) > 100 else ''}"
...
class CodeSearchResult:
    ...
    def __post_init__(self):
        ...
        if self.confidence_level is None:
            # Auto-assign confidence based on similarity score
    ...
    def get_relative_path(self, base_path: str) -> str:
        ...
        try:
            ...
            # Fall back to original path if relative calculation fails
            return self.file_path
