...
class ToolRecommendation:
    ...
    tool: Any  # ToolSearchResult or MockToolSearchResult
...
class RecommendationAlgorithms:
    ...
    def calculate_task_tool_fit(self,
        ...
        category_score = self._calculate_category_alignment_score(
            task_analysis.task_category,
            tool_category
        )
        
        parameter_score = self._calculate_parameter_compatibility_score(
            task_analysis,
            tool_metadata
        )
        ...
        combined_score = (
            ...
            category_score * 0.2 +  # Category alignment weight
            parameter_score * self.parameter_weight
        )
    ...
    def apply_ensemble_ranking(self,
                             candidates: List[Any],
                             task_analysis: TaskAnalysis,
                             context: Optional[Any] = None) -> List[ToolRecommendation]:
        ...
        for tool in candidates:
            ...
            capability_match = self._calculate_capability_match_score(
                task_analysis.required_capabilities,
                tool_metadata.get('capabilities', [])
            )
            ...
            parameter_compatibility = self._calculate_parameter_compatibility_score(
                task_analysis,
                tool_metadata
            )
        ...
        logger.info(f"Ensemble ranking complete, top recommendation: {recommendations[0].tool.name if recommendations else 'none'}")
    ...
    def _calculate_capability_match_score(self, 
                                        ...
                                        tool_capabilities: List[str]) -> float:
    ...
    def _calculate_complexity_alignment_score(self,
                                            task_complexity: str,
                                            tool_complexity: str,
    ...
    def _calculate_category_alignment_score(self,
                                          task_category: str,
                                          tool_category: str) -> float:
    ...
    def _calculate_parameter_compatibility_score(self,
                                               task_analysis: TaskAnalysis,
                                               tool_metadata: Dict) -> float:
    ...
    def _generate_recommendation_reasons(self,
                                       ...
                                       fit_score: float,
                                       capability_match: float,
                                       complexity_alignment: float) -> List[str]:
