        ...
        with cls.db_manager.get_connection() as conn:
            ...
            for tool in test_tools:
                ...
                """, (
                    ...
                    tool["category"], tool["tool_type"], tool["complexity_score"]
                ))
            ...
            for example in test_examples:
                conn.execute("""
                    ...
                    VALUES (?, ?, ?, ?, ?)
                """, (
                    example["tool_id"], example["use_case"], example["example_call"],
                    example["expected_output"], example["effectiveness_score"]
                ))
