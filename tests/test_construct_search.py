...
class TestConstructSearchResult:
    ...
    def test_confidence_level_calculation(self):
        ...
        # High confidence
        high_result = ConstructSearchResult(
        ...
        # Medium confidence  
        med_result = ConstructSearchResult(
        ...
        # Low confidence
        low_result = ConstructSearchResult(
    ...
    def test_to_code_search_result_conversion(self):
        ...
        construct_result = ConstructSearchResult(
            construct_id="test_id",
            file_path="/test/file.py",
            construct_type="function",
            name="test_function",
...
class TestConstructSearchOperations:
    ...
    def test_error_handling(self):
        ...
        results = self.construct_ops.search_constructs("test query")
