...
class TestIndexingPerformance:
    ...
    def test_indexing_memory_usage_large_repo(self, large_repo, mock_embedder, performance_baseline):
        ...
        try:
            ...
            # Should complete within timeout
            assert performance_metrics['elapsed_time'] < performance_baseline['indexing_timeout'] * 5  # Larger timeout for large repo
            
            # Memory usage should not exceed limit
            assert performance_metrics['peak_memory_mb'] < performance_baseline['max_memory_mb'] * 2  # Allow 2x for large repo
