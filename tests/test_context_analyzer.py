...
class TestContextAnalyzer:
    ...
    def project_info(self):
        ...
        return {
            ...
            "performance_requirements": {"response_time": "fast", "throughput": "medium", "memory_usage": "low"},
    ...
    def environment_info(self):
        ...
        return {
            "system_capabilities": {"cpu_cores": 8, "memory_gb": 16, "gpu_available": False, "os": "linux"},
            "security_requirements": ["encryption_at_rest", "secure_communication"],
            "resource_constraints": {"max_memory_usage": "8GB", "max_cpu_usage": "70%", "network_bandwidth": "limited"},
    ...
    def test_analyze_project_context_tool_ecosystem(self, context_analyzer, project_info):
        ...
        assert "python" in project_context.technology_stack or any(
            "python" in tool.lower() for tool in project_context.existing_tools
        )
...
class TestProjectAnalyzer:
    ...
    def test_analyze_performance_requirements_high(self, project_analyzer):
        ...
        requirements = {"response_time": "fast", "throughput": "high", "memory_usage": "low"}
    ...
    def test_analyze_performance_requirements_standard(self, project_analyzer):
        ...
        requirements = {"response_time": "medium", "throughput": "medium", "memory_usage": "medium"}
...
class TestEnvironmentAnalyzer:
    ...
    def test_assess_compute_capacity_high(self, env_analyzer):
        ...
        system_info = {"cpu_cores": 16, "memory_gb": 32, "gpu_available": True, "storage_type": "ssd"}
    ...
    def test_assess_compute_capacity_limited(self, env_analyzer):
        ...
        system_info = {"cpu_cores": 2, "memory_gb": 4, "gpu_available": False, "storage_type": "hdd"}
