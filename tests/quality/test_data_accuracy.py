...
from language_detection import LanguageDetector, detect_language_from_content, detect_language_from_extension
from code_construct_extractor import CodeConstructExtractor, extract_constructs_from_content
            ...
            for query, expected_relevant_files in test_queries:
                ...
                if len(scores) > 1:
                    ...
                    if score_diff > 0.1:  # Only fail if significantly unsorted
                        print(f"Warning: Results not perfectly sorted by relevance. Actual: {scores}, Expected: {sorted_scores}")
        ...
        with patch('search_utils.search_index_enhanced') as mock_semantic:
            ...
            for mode in modes_to_test:
                ...
                if len(results) > 0:
                    ...
                    for result in results:
                        assert hasattr(result, 'fusion_score') or hasattr(result, 'semantic_score') or hasattr(result, 'text_score')
