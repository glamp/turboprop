...
class TestMCPToolMigration:
    ...
    def test_get_current_version_with_existing_version(self, migration_manager):
        ...
        with migration_manager.db_manager.get_connection() as conn:
            ...
            conn.execute(
                "INSERT INTO schema_version (version, description) VALUES (1, 'Test version')"
            )
...
class TestDatabaseManagerMCPOperations:
    ...
    def test_store_and_get_tool_examples(self, db_manager):
        ...
        assert examples[0]['effectiveness_score'] == 0.9
    ...
    def test_search_mcp_tools_by_embedding(self, db_manager):
        ...
        filtered_results = db_manager.search_mcp_tools_by_embedding(
            query_embedding, limit=10, category='web'
        )
    ...
    def test_remove_mcp_tool(self, db_manager):
        ...
        db_manager.store_tool_parameter(
            parameter_id='param_1',
            tool_id='test_tool',
            parameter_name='test_param'
        )
        db_manager.store_tool_example(
            example_id='example_1',
            tool_id='test_tool',
            use_case='Test case'
        )
...
class TestIntegration:
    ...
    def test_search_functionality(self, populated_db):
        ...
        results = populated_db.search_mcp_tools_by_embedding(
            file_embedding, category='file_ops'
        )
        ...
        # Search parameters
        param_results = populated_db.search_tool_parameters_by_embedding(
            file_embedding, tool_id='bash'
        )
