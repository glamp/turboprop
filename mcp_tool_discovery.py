...
class MCPToolDiscovery:
    ...
    SYSTEM_TOOLS_CATALOG = {
        'bash': {
            'name': 'Bash',
            'description': 'Executes bash commands in a persistent shell session with timeout and security measures',
            'category': 'execution',
            'parameters': [
                {
                    'name': 'command',
        ...
        'glob': {
            'name': 'Glob',
            'description': 'Fast file pattern matching tool supporting glob patterns and modification time sorting',
            'category': 'search',
            'parameters': [
                {
                    'name': 'pattern',
