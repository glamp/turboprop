...
class AlternativeComparison:
    ...
    primary_tool: Any  # ToolRecommendation
    alternatives: List[Any]  # List of ToolRecommendation
...
class ExplanationGenerator:
    ...
    def generate_complexity_explanation(self,
                                      task_complexity: str,
                                      tool_complexity: str,
        ...
        if alignment_score >= 0.9:
            return f"Perfect complexity alignment - both task and tool are {task_complexity}, ensuring optimal usability."
    ...
    def generate_parameter_explanation(self,
    ...
    def generate_confidence_explanation(self,
                                      ...
                                      alignment_factors: Dict[str, float]) -> str:
...
class ComparisonAnalyzer:
    ...
    def analyze_capability_differences(self,
                                     ...
                                     alternative_capabilities: List[str]) -> Dict[str, List[str]]:
    ...
    def generate_trade_off_analysis(self,
                                   ...
                                   alternative_scores: Dict[str, float]) -> List[str]:
    ...
    def identify_decision_factors(self,
                                primary_rec: ToolRecommendation,
                                alternative_rec: ToolRecommendation) -> List[Dict[str, Any]]:
...
class GuidanceGenerator:
    ...
    def generate_parameter_recommendations(self,
                                         tool_parameters: Dict[str, Any]) -> List[str]:
        """Generate parameter configuration recommendations."""
        recommendations = []
        
        for param_name, param_info in tool_parameters.items():
            if param_info.get("required", False):
                recommendations.append(f"Required parameter '{param_name}': {param_info.get('description', 'No description')}")
            elif "default" in param_info:
                recommendations.append(f"Parameter '{param_name}': Keep default '{param_info['default']}' for most use cases")
    ...
    def generate_step_by_step_instructions(self,
                                         tool_name: str,
                                         user_skill: str) -> List[str]:
    ...
    def generate_common_pitfalls(self,
                                tool_complexity: str,
                                user_skill: str) -> List[str]:
        ...
        pitfalls.extend([
            ...
            "Keep backups when performing data transformations"
        ])
...
class RecommendationExplainer:
    ...
    def explain_recommendation(self,
        ...
        parameter_explanation = self.explanation_generator.generate_parameter_explanation(
            tool_parameters,
            {}  # Task parameter requirements (would be extracted from task analysis)
        )
    ...
    def compare_alternatives(self,
        ...
        for alt in alternatives:
            ...
            if cap_diff["primary_only"]:
                key_differences.append(f"{primary.tool.name} offers additional: {', '.join(cap_diff['primary_only'][:2])}")
    ...
    def _generate_alternative_scenarios(self, recommendation: ToolRecommendation) -> List[str]:
        ...
        return [
            ...
            "If tool complexity exceeds requirements"
        ]
    ...
    def _generate_error_handling_advice(self, tool_metadata: Dict) -> List[str]:
        ...
        return [
            ...
            "Implement proper exception handling around tool calls"
        ]