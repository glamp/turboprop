...
VALID_CATEGORIES = [
    ...
    "development", "notebook", "workflow", "data", "system"
]
...
class MCPToolValidator:
    ...
    def validate_search_parameters(
        ...
        if tool_type and tool_type not in VALID_TOOL_TYPES:
            errors.append(
                f"Invalid tool_type '{tool_type}'. Valid options: {', '.join(VALID_TOOL_TYPES)}"
            )
        ...
        if search_mode not in VALID_SEARCH_MODES:
            errors.append(
                f"Invalid search_mode '{search_mode}'. Valid options: {', '.join(VALID_SEARCH_MODES)}"
            )
...
def validate_search_parameters(
    ...
    return validator.validate_search_parameters(
